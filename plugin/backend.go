...
func Factory(ctx context.Context, c *logical.BackendConfig) (logical.Backend, error) {
	...
	// Load user credentials map & expired user credential from vault persistent storage
	b.Logger().Info("Retrieving user static credentials from vault persistent storage")
	if err := b.loadUserCredentialsFromVault(ctx, c.StorageView); err != nil {
